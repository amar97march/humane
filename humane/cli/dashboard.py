"""Humane TUI Dashboard — Industrial Utilitarian aesthetic.
...
from humane.core.models import Verdict
...
def _build_layout(conductor: Conductor) -> Layout:
    ...
    header_text = Text()
    header_text.append("  HUMANE ", style="bold white on color(214)")
...
def run_dashboard():
    ...
    console.print(f"\n[{AMBER}]Starting Humane dashboard...[/]")
