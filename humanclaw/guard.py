"""The @guard decorator — simplest integration point for HumanClaw."""
...
def guard(action_type: str = "default", confidence: float = 0.7, target_entity: Optional[str] = None):
    """Decorator that gates a function through the full HumanClaw decision stack.
    ...
    def decorator(func):
        ...
        wrapper._humanclaw_guarded = True
